...
local M = MelloUI:RegisterModule("Auras", {
	...
	options = {
		...
		{ type = "slider", key = "playerSize", name = "Icon Size", min = 20, max = 48, step = 1 },
		{ type = "slider", key = "playerPerRow", name = "Icons Per Row", min = 6, max = 20, step = 1 },
		...
		{ type = "slider", key = "targetSize", name = "Icon Size", min = 14, max = 36, step = 1 },
		{ type = "toggle", key = "targetOnlyMine", name = "Only My Debuffs",
		...
		{ type = "slider", key = "nameplateSize", name = "Icon Size", min = 12, max = 32, step = 1 },
	},
})
